...
class World:
    ...
    def draw_patch(self, source, legend, name, line_color='black', line_width=0.3):
        self.renderedBy['patches'] = (
            self.figPatch.patches('x', 'y', source=source, legend=legend, name=name, line_color=line_color,
